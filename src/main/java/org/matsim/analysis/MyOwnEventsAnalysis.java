...
public class MyOwnEventsAnalysis {
    public static void main(String[] args) {
        ...
        System.out.println("Count of 10 is " + count10);
        System.out.println("Count of 11 is " + count11);
        System.out.println("Count of 12 is " + count12);
        System.out.println("Count of 13 is " + count13);
        System.out.println("Count of 14 is " + count14);
    }
